...
namespace Rresturant.View
{
    public partial class PurshaceForm : Form
    {
        ...
        private void InitializeFunction()
        {
            ...
            this.listBoxSelectionItems.DataSource = null;
            this.listBoxSelectionItems.Items.Clear ();
            ...
            textBoxLocalSaveAmount.Enabled = false;
            textBoxDollarSaveAmount.Enabled = false;
            textBoxCustomerName.Enabled = false;
            textBoxInvoiceNO.Text = "";
            moneyCalcuation ();
            textBoxPercentageTransfer.Text = "0";
        ...
        public void EnableControlling()
        {
            ...
            textBoxLocalSaveAmount.Enabled = true;
            textBoxDollarSaveAmount.Enabled = true;
                ...
                else
                {
                    if ( textBoxTotalSaveAmount.Text == "0" )
                    {
                        ...
                        if ( result == DialogResult.Yes )
                        {
                            ...
                            buttonPrintInvoice_Click ( sender , e );
        ...
        private void SaveInvoices(string RUNORSAVE , string PayOrNot)
        {
            ...
            if ( dataGridViewItems.Rows.Count > 0 )
            {
                ...
                if ( textBoxDiscountPercentage.Text != "" && textBoxDiscountPercentage.Text != "0" )
                {
                    ...
                    PercentageDisount = float.Parse ( textBoxDiscountPercentage.Text );
                ...
                {
                    var TotalAmount = Convert.ToDouble ( textBoxTotalInvoice.Text.Trim () );
                    var DiscountAmount = float.Parse ( textBoxDiscountAmount.Text );
                ...
                if ( textBoxReminder.Text != "" || textBoxReminder.Text != "0" )
                {
                    ...
                    {
                        Reminder = Convert.ToDouble ( textBoxReminder.Text.Trim () );
                        Reminder *= -1;
                    }
                    else
                    {
        ...
        private void textBoxDiscountPercentage_TextChanged(object sender , EventArgs e)
        {
            ...
            if ( textBoxDiscountPercentage.Text != "" && textBoxDiscountPercentage.Text != "0" )
            {
                ...
                TotalAmount = Convert.ToDouble ( textBoxTotalInvoice.Text.Trim () );
                PercentageDisount = float.Parse ( textBoxDiscountPercentage.Text );
                PercentageDisount = PercentageDisount * 1 / 100;
                PercentageDisount = PercentageDisount * TotalAmount;
        ...
        private double IQPaidAmount()
        {
            if ( textBoxLocalSaveAmount.Text != "" )
            {
                ...
                //var currencyformat = CultureInfo.GetCultureInfo ( "AR-iq" );
                IQPaidAmount = Convert.ToDouble ( textBoxLocalSaveAmount.Text.Trim () );
                return IQPaidAmount;
            }
            else
                return 0.0;
        ...
        {
            //var currencyformat = CultureInfo.GetCultureInfo ( "AR-iq" );
            var InvoiceNetAmount = Convert.ToDouble ( textBoxFinalAmount.Text.Trim () );
            var TotalPaidAmount = Convert.ToDouble ( textBoxTotalSaveAmount.Text.Trim () );
        ...
        private void textBoxDiscountAmount_TextChanged(object sender , EventArgs e)
        {
            if ( textBoxDiscountAmount.Text != "0" && textBoxDiscountAmount.Text != "" )
            {
                ...
                //var currencyformat = CultureInfo.GetCultureInfo ( "AR-iq" );
                TotalAmount = Convert.ToDouble ( textBoxTotalInvoice.Text.Trim () );
                DiscountAmount = float.Parse ( textBoxDiscountAmount.Text );
        ...
        private void PurshaceForm_Activated(object sender , EventArgs e)
        {
            ...
            {
                buttonNewInvoice.Visible = false;
                buttonPausesInvoices.Visible = false;
                dataGridViewItems.Rows.Clear ();
                counter = 1;
                var UsedClass = new BasicClass ();
                var dt = new DataTable ();
                ...
                if ( dt.Rows.Count > 0 )
                {
                    ...
                    textBoxUserName.Text = dt.Rows[0]["EnteredUser"].ToString ();
        ...
        private void textBoxBarCode_TextChanged(object sender , EventArgs e)
        {
            ...
            if ( textBoxBarCode.Text != "" )
            {
                ...
                param[0].Value = textBoxBarCode.Text.Trim ();
                dt = UsedClass.selectdata ( "CasherForm_Selectitem_UsingBarcodeORName" , param );
                listBoxSelectionItems.DataSource = dt;
                listBoxSelectionItems.DisplayMember = "ItemName";
            }
            else
            {
                this.listBoxSelectionItems.DataSource = null;
        ...
        private void dataGridViewItems_SelectionChanged_1(object sender , EventArgs e)
        {
        ...
        private void dataGridViewItems_CellContentClick_1(object sender , DataGridViewCellEventArgs e)
        {
            if ( e.RowIndex >= 0 )
            {
        ...
        private void dataGridViewItems_CellValueChanged_1(object sender , DataGridViewCellEventArgs e)
        {
            if ( e.RowIndex >= 0 )
            {
